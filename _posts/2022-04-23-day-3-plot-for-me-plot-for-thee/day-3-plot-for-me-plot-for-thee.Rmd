...
```{r, echo=TRUE}
# Preliminary work that groups the number of guesses in a tibble, and counts the number of occurrences for each number of guesses.
grouped_guesses_table <- tibble(one_guess = 0,
...
## Represent as kable.
grouped_guesses_kable <- knitr::kable(grouped_guesses_table,
...
percentage_guesses_table <- tibble(one_guess = 0,
...
## Represent as kable.
percentage_guesses_kable <- knitr::kable(percentage_guesses_table,
                                         col.names = c("One guess", "Two guesses", "Three guesses",
                                                    "Four guesses", "Five guesses", "Six guesses"),
...
mean_var_sd_guesses <- tibble(mean_guesses,
                              var_guesses,
                              sd_guesses)

## Represent as kable.
mean_var_sd_kable <- knitr::kable(mean_var_sd_guesses,
...
And there we have it! You can recreate your own Wordle guess distribution bar graph using the code above, simply updating some of the code above with your own data.
